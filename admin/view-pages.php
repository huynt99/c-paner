...
?>
    <div id="content">
        ...
        <table>
			...
			<?php
			$que
				= "SELECT p.page_id, p.page_name, CONCAT_WS(' ', u.first_name, u.last_name) AS name, DATE_FORMAT(p.post_on, '%b %d %Y') AS date, p.content";
			$que .= " FROM pages AS p";
			$que .= " JOIN users AS u";
			$que .= " USING(user_id)";
			...
			while ($row = mysqli_fetch_array($res)) :
                ...
                <tr>
                    ...
                    <td><a class="delete"
                           href="delete-pages.php?pid=<?php echo $row['page_id']; ?>&pagename=<?php echo $row['page_name']; ?>">Delete</a>
                    </td>
                </tr>
			<?php endwhile; ?>
            </tbody>
