...
if (isset($_GET['pid']) && filter_var($_GET['pid'], FILTER_VALIDATE_INT, array('min_range' => 0))) {
    $pid = $_GET['pid'];
} else {
...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(empty($error)){
        //code
    $que = "UPDATE `pages` SET page_name = '{$page_name}', cat_id = $category, position = $position, content = '{$content}'";
