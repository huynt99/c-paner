...
?>
    <div id="content">
        ...
        <table>
			...
			<?php
			$que
				= "SELECT c.cat_id, c.cate_name, c.position, c.user_id, CONCAT_WS(' ', u.first_name, u.last_name) AS name";
			...
			while ($row = mysqli_fetch_array($res)) :
                ...
                <tr>
                    ...
                    <td><a class="delete"
                           href="delete-categories.php?cid=<?php echo $row['position']; ?>&catename=<?php echo $row['cate_name']; ?>">Delete</a>
                    </td>
                </tr>
			<?php endwhile; ?>
            </tbody>
