        ...
        <form id="contact" method="POST">
            ...
            <fieldset>
                ...
                <div>
					...
					<?php if (isset($error) &&
						in_array('name', $error)) echo "<p class='warning'>Please enter your name</p>" ?>
                    <input type="text" name="name" id="" required
                           value="<?php echo isset($clean['name']) ? htmlentities($clean['name'], ENT_QUOTES, 'utf-8') :
						       '' ?>">
                </div>
                <div>
                    ...
                    <input type="email" name="email" id="" required value="<?php echo isset($clean['email']) ?
						htmlentities($clean['email'], ENT_QUOTES, 'utf-8') : '' ?>">
                </div>
                <div>
                    <lable for="message">Message</lable>
					<?php if (isset($error) &&
						in_array('message', $error)) echo "<p class='warning'>Please enter your message</p>" ?>
                    <div>
